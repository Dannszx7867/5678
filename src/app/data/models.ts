...
const modelData = [
  ...
  { id: '7', name: 'Kerolay.Chaves', persona: 'milf', description: '¿Crees que podrías con ella?', imageId: 'model-7', videoUrl: '/video_06.mp4', evaluationImageUrl: 'https://i.imgur.com/7lJ1GkP.png', nationality: '🇧🇷', photos: 215, videos: 55, followers: '22.5K', attributes: { beleza: 92, estilo: 95, interacao: 93 } },
];
